...
class RecipeAdapter (
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if (convertView == null) {
            ...
            //3
            holder = ViewHolder()
            holder.thumbnailImageView = view.findViewById(R.id.imageView3) as ImageView
            holder.titleTextView = view.findViewById(R.id.textView8) as TextView
            holder.subtitleTextView = view.findViewById(R.id.textView9) as TextView
            holder.detailTextView = view.findViewById(R.id.textView6) as TextView
            //4
            view.tag = holder
        } else {
            //5
        ...
        subtitleTextView.text = recipe.title
        detailTextView.text = recipe.title
